...
/******************************************************************************
PURPOSE: allNull - Are all array items null?
INPUTS:  const void* items[] - The array of items to check.
         Integer count       - The number of items in the array.
RETURNS: Integer 1 if all items are null, else 0.
******************************************************************************/

Integer allNull( const void* items[], Integer count ) {
  PRE02( items, IN_RANGE( count, 1, INTEGER_MAX / sizeof *items ) );
  Integer result = 1;
  Integer index = 0;
...
/******************************************************************************
PURPOSE: nonNull - Are all array items non-null?
INPUTS:  const void* items[] - The array of items to check.
         Integer count       - The number of items in the array.
RETURNS: Integer 1 if all items are non-null, else 0.
******************************************************************************/

Integer nonNull( const void* items[], Integer count ) {
  PRE02( items, IN_RANGE( count, 1, INTEGER_MAX / sizeof *items ) );
  Integer result = 1;
  Integer index = 0;
...
/******************************************************************************
PURPOSE: rotate2ByteWordIfLittleEndian() - Rotate 2-bytes of value if on a
         little-endian platform.
INPUTS:  void* value  2-byte value to rotate.
OUTPUTS: void* value  Rotated value.
******************************************************************************/

void rotate2ByteWordIfLittleEndian( void* value ) {

#if IS_LITTLE_ENDIAN

  PRE0( value );
  assert_static( sizeof (unsigned short) == 2 );
  unsigned short* const ivalue = value;
  const unsigned short value2 = *ivalue;
...
void rotate2ByteArrayIfLittleEndian( void* array, Integer count ) {
