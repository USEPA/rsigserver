...
extern void rotate8ByteWordIfLittleEndian( void* value );
...
extern void windDirectionAndSpeed( const Real windU, const Real windV,
                                   Real* windDirection, Real* windSpeed );

extern void windUV( const Real windDirection, const Real windSpeed,
